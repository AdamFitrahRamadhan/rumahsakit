<div class="panel">
	...
	<div class="panel-body">
		...
		<table class="table">
			...
			<tbody>
				<?php $no = 0; foreach ($tampil_pasien as $pas): $no++ ?>
					<tr>
						<td><?=$no?> </td>
						...
						<td><?=$pas->telepon?> </td>
						<td>
							<a href="#edit" onclick="edit(<?=$pas->id_pasien?>)" class="btn btn-info" data-toggle="modal">Ubah</a>
							<a href="<?=base_url('index.php/pasien/hapus/'.$pas->id_pasien)?>" class="btn btn-danger" onclick="return confirm('Apakah anda yakin?')">Hapus</a>
						</td>
					</tr>
				<?php endforeach ?>
			</tbody>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?=base_url('index.php/pasien/tambah_pasien')?>" method="POST">
					<table class="table">
						<tr>
							<td>nama pasien</td>
				...
				<form action="<?=base_url('index.php/pasien/ubah')?>" method="POST">
					<table class="table">
						...
						<tr>
							<td>telepon</td>
							<td>
							<input type="number" id="telepon" name="telepon" class="form-control"><br>
							</td>
						</tr>
						<tr>
							<td>jenis obat</td>
